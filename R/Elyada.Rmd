...
DimPlot(myo_norm)
FeaturePlot(myo_norm, features = "LYZ")
FeaturePlot(myo_norm, features = "FCGR3A")
FeaturePlot(myo_norm, features = "CD14")
VlnPlot(myo_norm, features = "LYZ")
VlnPlot(myo_norm, features = "FCGR3A")
VlnPlot(myo_norm, features = "CD14")
VlnPlot(myo_norm, features = "S100A8")
VlnPlot(myo_norm, features = "S100A9")
```
...
pdac@meta.data %<>% mutate(label_broad = case_when(seurat_clusters == 0 ~ "Macrophage", 
                           ...
                           label_fine_old = case_when(rownames(.) %in% basal_cells ~ "Basal-like PDAC", 
                                                      ...
                                                      TRUE ~ label_broad), 
                           # mroe accurate ref. pop. now that I've annotated the immune cells
