...
myo_tumor_mx <- FindAllMarkers(myo_tumor, logfc.threshold = 0.5, test.use = "wilcox", only.pos = TRUE)
myo_tumor_mx %>% with_groups(cluster, slice_head, n = 8) %>% View()
myo_tumor_mx %>% filter(cluster == 7) %>% View()
DimPlot(myo_tumor)
DimPlot(myo_tumor, group.by = "sample")
FeaturePlot(myo_tumor, features = "TYMS")  # unknown
FeaturePlot(pdac, "PCLAF")
FeaturePlot(myo_tumor, features = "PCLAF") # unknown
FeaturePlot(myo_tumor, features = "TOP2A") # unknown
```
...
The resident macrophages can be found in cluster 0, and the alternatively-activated ones in cluster 2. 
...
```{r}
p75 <- FeaturePlot(myo_tumor, reduction = "tsne", features = "LYZ", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p76 <- FeaturePlot(myo_tumor, reduction = "tsne", features = "CD14", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p77 <- FeaturePlot(myo_tumor, reduction = "tsne", features = "FCGR3A", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p78 <- FeaturePlot(myo_tumor, reduction = "tsne", features = "S100A8", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p79 <- FeaturePlot(myo_tumor, reduction = "tsne", features = "S100A9", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
...
```{r}
p80 <- FeaturePlot(myo_tumor, reduction = "tsne", features = "FCER1A", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
p81 <- FeaturePlot(myo_tumor, reduction = "tsne", features = "CLEC10A", pt.size = 1.5) + 
       scale_color_gradientn(colors = wesanderson::wes_palette("Zissou1")) + 
       theme_yehlab() + 
       NoLegend() + 
       theme(axis.title = element_blank())
